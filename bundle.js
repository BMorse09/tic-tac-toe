...
/***/ function(module, exports, __webpack_require__) {
	...
	var modalEventHandlers = function modalEventHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGameById = function onGetGameById(event) {
	  event.preventDefault();
	  api.getGameById().done(ui.onGetGameByIdSuccess).fail(ui.failure);
	  // console.log(data);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGameById = function getGameById(data) {
	  return $.ajax({
	    url: app.host + "/games",
	    method: 'GET',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGameByIdSuccess = function onGetGameByIdSuccess(data) {
	  // console.log(data.length);
	  app.games = data.games;
	  var length = app.games.length;
	...
	module.exports = {
	  ...
	  onGetGameByIdSuccess: onGetGameByIdSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clearBoard = function clearBoard(data) {
	  app.game = data.game;
	};
